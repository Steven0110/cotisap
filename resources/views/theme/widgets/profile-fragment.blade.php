					...
					<div class="an-bootstrap-custom-tab an-vertical-tab">
                      <div class="an-tab-control listview">
                        ...
                        <ul class="nav nav-tabs text-center" role="tablist">
                          <li role="presentation" class="active"><a href="#general" aria-controls="diska" role="tab" data-toggle="tab" aria-expanded="true"><i class="ion-ios-person-outline"></i>Información general</a>
                          </li>
                          <!--<li role="presentation" class=""><a href="#diskb6" aria-controls="diskb" role="tab" data-toggle="tab" aria-expanded="false"><i class="ion-earth"></i>Tab B</a>
                          </li>-->
                        </ul>
                      </div>
                        	...
                        	<div class="row">
	                          	<div class="col-md-6">
									...
									<div class="an-input-group">
										...
										<input type="text" id="slpname" class="an-form-control" disabled="disabled">
									</div>
	                          	</div>
	                          	<div class="col-md-6">
